    ...
    208: function (t, e, n) {
      ...
      var i,
        ...
        p = function (t, e, n) {
          ...
          return function () {
            e.value >= 0 &&
              (n || d.has(e) || "hidden" === document.visibilityState) &&
              ((e.delta = e.value - (i || 0)),
            ...
            r = u("paint", function (t) {
              "first-contentful-paint" === t.name &&
                ...
                t.startTime < i.timeStamp &&
                  ((a.value = t.startTime), a.entries.push(t), d.add(a), n()));
            });
          r &&
            ((n = p(t, a, e)),
            f(function (i) {
              (a = c("FCP")),
                ...
                requestAnimationFrame(function () {
                  requestAnimationFrame(function () {
                    (a.value = performance.now() - i.timeStamp), d.add(a), n();
                  });
                });
            }));
        },
          ...
          var n,
            ...
            v = function (t) {
              t.startTime < r.timeStamp &&
                ((m.value = t.processingStart - t.startTime),
                m.entries.push(t),
                d.add(m),
                n());
            },
        ...
        k = function (t, e) {
          ...
          if (o) {
            ...
            var m = function () {
              d.has(a) ||
                (o.takeRecords().map(r), o.disconnect(), d.add(a), n());
            };
            ["keydown", "click"].forEach(function (t) {
              addEventListener(t, m, { once: !0, capture: !0 });
            }),
              s(m, !0),
              f(function (i) {
                (a = c("LCP")),
...
//# sourceMappingURL=3.0f42ef80.chunk.js.map
